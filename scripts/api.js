...
export const FollowingLabel = document.querySelector(".FollowingLabel");

export const UsernameLabels = document.querySelectorAll(".UsernameLabel");
...
export const AccountButton = document.querySelector(".AccountButton");
