            ...
            Post.innerHTML = `
                <div>
                    <div>
                        ...
                        <img style="position: absolute; right: 8px; cursor: pointer; border: none; display: ${Document.Author === JSON.parse(localStorage.getItem("User")).Username ? "" : "none"};" src="../images/Dots.svg">
                    </div>
...
Array.from(Api.Filters.children).forEach(Filter => {
    Filter.addEventListener("click", () => {
        FetchPosts(Filter.getAttribute("href"));
        Array.from(Api.Filters.children).forEach(Filter => Filter.removeAttribute("active"));
